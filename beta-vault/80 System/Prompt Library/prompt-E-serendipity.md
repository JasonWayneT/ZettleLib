...
CONFIDENCE THRESHOLD: Only suggest connections you are fairly confident about. If you cannot find
3 qualifying pairs, surface fewer — do not force weak connections to meet the quota.
Keep confidence scores internal — never show them to the user.
