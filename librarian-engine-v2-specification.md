...
**Philosophy:** AI = Labor, Human = Governance  
**Implementation:** Obsidian + Local AI (Gemma 4)
...
We're building an **autonomous knowledge management system** that implements the Zettelkasten method using local AI (Gemma 4) to eliminate manual filing overhead while preserving—and enhancing—the core thinking benefits of the original method.

### Core Philosophy

**AI handles organizational labor. Human handles intellectual governance.**

### Key Innovation

Unlike static note-taking apps, this system actively participates in knowledge creation through surprise connections, dialectical thinking, and progressive idea refinement.

### Implementation Approach

- **Platform:** Obsidian (vault interface) + Python scripts (orchestration)
- **AI Model:** Gemma 4 (local via Ollama)
...
1. Automates filing decisions but requires human approval
2. Enforces atomicity and prevents bloated notes
3. Generates surprise connections across conceptual domains
4. Tracks idea maturity from fleeting → validated → published
5. Maintains audit trails so AI decisions are reversible
